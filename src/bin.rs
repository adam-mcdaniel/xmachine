...
fn main() {
	...
	xasm.load();
	xasm.call();
	xasm.push(Value::function(|xasm: &mut Machine| {xasm.push(Value::string("l does not evaluate to true :("));
	xasm.copy();
	xasm.push(Value::string("println"));
	xasm.load();
	xasm.call();
	}, &xasm));
	xasm.push(Value::function(|xasm: &mut Machine| {xasm.push(Value::string("l is true!!"));
	xasm.copy();
	xasm.push(Value::string("println"));
	xasm.load();
	xasm.call();
	}, &xasm));
	xasm.push(Value::function(|xasm: &mut Machine| {xasm.push(Value::string("l"));
	xasm.load();
	}, &xasm));
	xasm.if_then_else();
